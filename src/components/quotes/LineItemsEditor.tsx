...
import { calculateLineTotal } from "@/hooks/useQuoteCalculations";
...
export function LineItemsEditor({ items, onItemsChange }: LineItemsEditorProps) {
  ...
  const handleUpdate = (id: string, field: keyof LineItem, value: string | number) => {
    onItemsChange(
      items.map((item) =>
