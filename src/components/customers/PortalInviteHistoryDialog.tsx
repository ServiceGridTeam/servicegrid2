...
import { PortalAccessAuditLog } from "./PortalAccessAuditLog";
...
import { Send, History, CheckCircle, Clock, XCircle, Mail, User, Calendar, ShieldX, FileText } from "lucide-react";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-6">
          ...
          {/* Tabs for Invite History and Audit Log */}
          <Tabs defaultValue="invites" className="w-full">
            ...
            <TabsContent value="audit" className="mt-4">
              <PortalAccessAuditLog customerId={customerId} />
            </TabsContent>
          </Tabs>
