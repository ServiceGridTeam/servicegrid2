...
serve(async (req) => {
  ...
  try {
    ...
    console.log("[send-campaign-emails] Function invoked");

    // Use service role for database operations (allows both internal cron calls and authenticated user calls)
